...
- **Class from certificate** (option 2 above): the natural next step
  ...
  on `AuthConfig`. Implemented as `SERVER-001` v0.21.0 / FR-031 (PR
  #166), once the accessor landed upstream as `Rusty-Mill/rusty_mill`
  PR #148.*
...
- 2026-09-02: Accepted as proposed; the verification plan's throwaway
  ...
  (PR #134.)
- 2026-09-02: Implemented as `SERVER-001` v0.13.0 / FR-023 (PR #135),
