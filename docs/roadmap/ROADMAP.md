...
implementation remains a separate, not-yet-started unit as of this
row, extending `SERVER-001` with new FRs before any server code lands,
matching how `SERVER-AUTH`/`SERVER-TRANSACTION` each followed their own
design's acceptance.
